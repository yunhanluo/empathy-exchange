...
class _MessageState extends State<Message> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget paddedMessage = (sender == Sender.self || ! senderToken.contains('@')) ? mainChatMessage : Tooltip(
        preferBelow: true,
        decoration: BoxDecoration(
          color: Colors.grey[400]?.withAlpha(235),
          borderRadius: BorderRadius.circular(6),
        ),
        richMessage: WidgetSpan(
            child: ConstrainedBox(
                constraints: const BoxConstraints(
                    maxHeight: 30, minHeight: 20, minWidth: 30),
                child: Row(
                  ...
                  children: [
                    ...
                    const Text("Award Kindness Badge"),
                  ],
                ))),
